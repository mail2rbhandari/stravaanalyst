...
if client_id and client_secret:
    if st.sidebar.button("Login with Strava"):
        # Use fixed redirect for deployed app
        redirect_uri = "https://stravaanalyst1.streamlit.app"   # CHANGE TO YOUR URL
        ...
        st.sidebar.info("After approval, copy code from URL")

    code = st.session_state.get("auth_code") or st.sidebar.text_input("Authorization Code", key="code")
